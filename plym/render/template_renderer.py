...
class TemplateRenderer:
    ...
    def render_post(self, context: dict[str, Any]) -> str:
    ...
    def _with_globals(self, context: dict[str, Any]) -> dict[str, Any]:
        return {
            **context,
            "site": self._site,
    ...
    def _render_user(self, name: str, context: dict[str, Any]) -> str:
        try:
